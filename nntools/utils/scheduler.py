...
SCHEDULER = {
    ...
    'MultiplicativeLR': (
    torch.optim.lr_scheduler.MultiplicativeLR, 'on_epoch', lambda epoch, iteration, epoch_size: epoch),
    ...
    torch.optim.lr_scheduler.CosineAnnealingWarmRestarts, 'on_iteration', lambda epoch, iteration,
                                                                                 epoch_size: None)
}
