...
class SeparableConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, dilation=1, bias=False,
        ...
        self.depthwise = nn.Conv2d(in_channels, in_channels, kernel_size, stride, padding=0,
                                   dilation=dilation,
                                   groups=in_channels,
                                   bias=bias)
...
class Conv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, padding='auto', dilation=1, bias=False,
                 norm=nn.Identity(), activation=nn.ReLU()):
